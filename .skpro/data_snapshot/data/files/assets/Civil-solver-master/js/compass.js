document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.getElementById("notice").innerHTML = "Cool! The DeviceOrientationEvent API is supported by this device.";
  window.addEventListener('deviceorientation', function(eventData) {
    ...
    document.getElementById("notice").innerHTML = "Unfortunately. The DeviceOrientationEvent API is not supported by this device."
};
