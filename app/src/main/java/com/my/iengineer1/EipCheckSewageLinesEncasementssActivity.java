...
public class EipCheckSewageLinesEncasementssActivity extends AppCompatActivity {
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesEncasementssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesEncasementssActivity.this.getSystemService(PRINT_SERVICE);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام طبقة التغليف أعلي المواسير لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق\n" +
                "بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط ومنسوب ميه الماسورة بنهاية الفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
