...
public class ToipccplainconcretefootingsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipccplainconcretefootings);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview11.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview11)
				        .autoHide(true, 5000)
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				try{
					if ((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) {
		...
		textview530.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview530)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview965.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview965)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview724.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview724)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview335.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview335)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview340.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview340)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview344.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview344)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview350.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview350)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview529.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview529)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview537.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview537)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview348.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview348)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview971.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview971)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview316.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview316)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview844.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview844)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview977.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview956)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview832.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview832)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للقواعد التي يتم ادخال أبعاده وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة ( جنيه )")
				        .textColor(0xFFFFFFFF)
		...
		textview859.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview859)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview861.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview861)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview962.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview962)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview904.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview904)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("سعر ال م٣ من المياه\n( جنيه / م٣ )\nفي بعض المشروعات لا يتم حساب تكلفة لمياه الخلط وبالتالى يكون سعرها صفر اي بيتم أهمال تكلفة مياه الخلط\n\" مدخل إختياري في حالة عدم الرغبة في إدخاله سيقوم البرنامج بافتراضه بقيمة = ٠٠.٠٠ جنيه/م٣ \"")
				        .textColor(0xFFFFFFFF)
		...
		textview929.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccplainconcretefootingsActivity.this, textview929)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للقواعد التي يتم ادخال أبعاده وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة ( جنيه )")
				        .textColor(0xFFFFFFFF)
...
*/
		...
		dynamic_element_type.setText("نموذج قاعدة رقم :");
		dynamic_element_symble.setText("ق");
...
*/
		...
		dynamic_element_remove.setText("الغاء القاعدة\nالحالية");
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccplainconcretefootingsActivity.this); //change the activity name
