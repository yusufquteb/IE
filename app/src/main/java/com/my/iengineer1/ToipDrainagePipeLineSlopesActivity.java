...
public class ToipDrainagePipeLineSlopesActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toip_drainage_pipe_line_slopes);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/63Y9Tp7OOR0"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipDrainagePipeLineSlopesActivity.this); //change the activity name
