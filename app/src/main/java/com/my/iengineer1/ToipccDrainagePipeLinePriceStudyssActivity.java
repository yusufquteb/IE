...
public class ToipccDrainagePipeLinePriceStudyssActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_drainage_pipe_line_price_studyss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		edittext48.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* نسبة هالك التداخل للمواسير أثناء التركيب\nفي حالة الرغبة في ادخال هالك تداخل المواسير أثناء التركيب كنسبة من التوريد وليس كمبلغ ثابت \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة ٥ % \"");
				return true;
			}
		});
		...
		button10.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ((edittext71.getText().toString().equals("") || edittext71.getText().toString().equals(".")) || (edittext71.getText().toString().equals("-") || (Double.parseDouble(edittext71.getText().toString()) < 0))) {
					edittext71.setText(String.valueOf(3));
				}
	...
	public void _PrintHelper(final View _view) {
		...
		android.webkit.WebView webView = new android.webkit.WebView(ToipccDrainagePipeLinePriceStudyssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new android.webkit.WebViewClient() {
			@Override
			public void onPageFinished(android.webkit.WebView view, String url) {
				android.print.PrintManager pm = (android.print.PrintManager) ToipccDrainagePipeLinePriceStudyssActivity.this.getSystemService(PRINT_SERVICE);
