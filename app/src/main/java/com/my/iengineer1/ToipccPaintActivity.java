...
public class ToipccPaintActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_paint);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				drainage_pipe_line.setClass(getApplicationContext(), ToipccPaintsActivity.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				drainage_pipe_line.setClass(getApplicationContext(), ToipccPaintssActivity.class);
				startActivity(drainage_pipe_line);
			}
		});
	}
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccPaintActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccPaintActivity.this.getSystemService(PRINT_SERVICE);
