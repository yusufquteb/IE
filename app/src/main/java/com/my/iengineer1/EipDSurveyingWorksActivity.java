...
public class EipDSurveyingWorksActivity extends AppCompatActivity {
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipDSurveyingWorksActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipDSurveyingWorksActivity.this.getSystemService(PRINT_SERVICE);
