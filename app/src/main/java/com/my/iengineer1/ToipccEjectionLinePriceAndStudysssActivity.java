...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccEjectionLinePriceAndStudysssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccEjectionLinePriceAndStudysssActivity.this.getSystemService(PRINT_SERVICE);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "٣ - مدخل إختياري في حالة عدم ادخاله سيقوم البرنامج بافتراض قيمته طبقا للقيمة المقترحة داخل مستطيل الادخال او سيقوم باهماله اذا كان لا يؤثر في الحسابات\n" +
                "٤ - لأضافة خط طرد جديد أضغط علي الزر\n" +
                "أضافة خط\n" +
                "طرد جديد\n" +
                "اجمالي قيمة كل خطوط الطرد\n" +
                "( جنيه )\n" +
                "=\n" +
                "جنيه\n" +
                "00.00")
