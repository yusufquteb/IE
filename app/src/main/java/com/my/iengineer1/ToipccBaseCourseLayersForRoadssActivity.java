...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccBaseCourseLayersForRoadssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccBaseCourseLayersForRoadssActivity.this.getSystemService(PRINT_SERVICE);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "٣ - مدخل إختياري لا يؤثر في الحسابات\n" +
                "٤ - لأضافة فرعة جديدة أضغط علي الزر\n" +
                "-----‐---------------------------------")
