...
public class ToipccBaseCourseLayersForRoadssActivity extends AppCompatActivity {
	...
	private HorizontalScrollView hscroll143;
	...
	private HorizontalScrollView hscroll304;
	...
	private HorizontalScrollView hscroll142;
	...
	private HorizontalScrollView hscroll305;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_base_course_layers_for_roadss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		hscroll143 = findViewById(R.id.hscroll143);
		...
		edittext301 = findViewById(R.id.edittext301);
		...
		textview2356 = findViewById(R.id.textview2356);
		...
		hscroll304 = findViewById(R.id.hscroll304);
		...
		textview2357 = findViewById(R.id.textview2357);
		...
		hscroll142 = findViewById(R.id.hscroll142);
		...
		textview2376 = findViewById(R.id.textview2376);
		...
		hscroll305 = findViewById(R.id.hscroll305);
		...
		textview2359 = findViewById(R.id.textview2359);
		...
		textview2377 = findViewById(R.id.textview2377);
		...
		edittext15.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				edittext301.setText(String.valueOf(00.00));
				edittext301.setTextColor(0xFFE91E63);
		...
		textview57.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview57)
				        .autoHide(true, 5000)
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0)))) || ((((edittext7.getText().toString().equals("") || edittext7.getText().toString().equals(".")) || edittext7.getText().toString().equals("-")) || ((edittext8.getText().toString().equals("") || edittext8.getText().toString().equals(".")) || edittext8.getText().toString().equals("-"))) || (((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))) || ((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0)))))) {
					...
					edittext301.setText(String.valueOf(Double.parseDouble(edittext2.getText().toString()) - Double.parseDouble(edittext15.getText().toString())));
					edittext301.setTextColor(0xFF000000);
					if ((Double.parseDouble(edittext7.getText().toString()) == 0) || (Double.parseDouble(edittext8.getText().toString()) == 0)) {
						edittext199.setText(String.valueOf(Double.parseDouble(edittext4.getText().toString())));
						edittext9.setText(String.valueOf(Double.parseDouble(edittext4.getText().toString())));
					}
					else {
						edittext199.setText(String.valueOf(((Double.parseDouble(edittext5.getText().toString()) * (Double.parseDouble(edittext7.getText().toString()) / Double.parseDouble(edittext8.getText().toString()))) + Double.parseDouble(edittext4.getText().toString())) + (Double.parseDouble(edittext5.getText().toString()) * (Double.parseDouble(edittext7.getText().toString()) / Double.parseDouble(edittext8.getText().toString())))));
						edittext9.setText(String.valueOf(((Double.parseDouble(edittext6.getText().toString()) * (Double.parseDouble(edittext7.getText().toString()) / Double.parseDouble(edittext8.getText().toString()))) + Double.parseDouble(edittext199.getText().toString())) + (Double.parseDouble(edittext6.getText().toString()) * (Double.parseDouble(edittext7.getText().toString()) / Double.parseDouble(edittext8.getText().toString())))));
					}
					edittext199.setTextColor(0xFF000000);
					edittext9.setTextColor(0xFF000000);
					edittext10.setText(String.valueOf(((Double.parseDouble(edittext199.getText().toString()) + Double.parseDouble(edittext9.getText().toString())) / 2) * Double.parseDouble(edittext6.getText().toString())));
					edittext10.setTextColor(0xFF000000);
					if (Double.parseDouble(edittext301.getText().toString()) < 0) {
						...
						textview54.setVisibility(View.GONE);
						edittext11.setText(String.valueOf(Double.parseDouble(edittext199.getText().toString()) * Double.parseDouble(edittext301.getText().toString())));
						edittext12.setText(String.valueOf(Double.parseDouble(edittext301.getText().toString()) * Double.parseDouble(edittext10.getText().toString())));
		...
		edittext301.addTextChangedListener(new TextWatcher() {
			@Override
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext301.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
		...
		edittext199.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext199.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 8)});
			}
		...
		edittext10.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext10.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
		...
		edittext11.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext11.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
		...
		edittext12.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext12.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
		...
		edittext14.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext14.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
				edittext17.setText(String.valueOf(Double.parseDouble(edittext11.getText().toString()) + Double.parseDouble(_charSeq)));
			}
		...
		edittext17.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext17.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
		...
		edittext18.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext18.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 14)});
...
*/
		...
		textview1264.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview1264)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* نسبة الهالك والأنضغاط والدمك\n( % )\nوهي تعبر عن نسبة الهالك والنسبة التي تحدث بسبب هبوط وانضغاط طبقة الأحلال والردم نتيجة التشغيل والدمك \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة ٣٠ % \" وذلك عند الضغط علي زرار أحسب")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		edittext28.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext28.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 16)});
				/*
...
*/
		...
		button8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				if (SketchwareUtil.isConnected(getApplicationContext())) {
					...
					edittext215.setText("");
					edittext216.setText("");
					edittext217.setTextColor(0xFF000000);
					edittext206.setText("");
					edittext207.setText("");
		...
		button10.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((edittext34.getText().toString().equals("") || edittext34.getText().toString().equals(".")) || (edittext34.getText().toString().equals("-") || (Double.parseDouble(edittext34.getText().toString()) < 0))) || ((edittext35.getText().toString().equals("") || edittext35.getText().toString().equals(".")) || (edittext35.getText().toString().equals("-") || (Double.parseDouble(edittext35.getText().toString()) < 0)))) {
					...
					edittext38.setText(String.valueOf(Double.parseDouble(edittext35.getText().toString()) * Double.parseDouble(edittext18.getText().toString())));
		...
		edittext39.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext39.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 16)});
			}
		...
		textview416.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview416)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview415.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview415)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview414.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview414)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview420.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview420)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقل\n( جنيه / م٣ )\nوهو يعبر عن المبلغ الذي يتكلفة النقل لمواد طبقات الأساس من المحاجر الي موقع العمل أو داخل الموقع بالجنيه لكل ١م٣\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview419.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview419)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview418.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview418)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* حمولة\nالسيارة\n( م٣ )\n\nوهو يعبر عن الكمية التي يمكن تقوم السيارة النقل لبنقلها من مواد طبقة الأساس من المحاجر الي موقع العمل أو داخل الموقع \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٢٠ م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview408.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview408)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالفنشر\n( جنيه / يوم )\nوهو يعبر عن المبلغ الذي يتقاضاه الفنشر بنهاية اليوم عن الأعمال التي قام بتنفيذها خلال اليوم \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / يوم \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview407.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview407)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview406.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview406)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("المعدل\nاليومي\nللفنشر\n( م٣ / يوم )\nوهو يعبر عن الكمية التي يمكن للفنشر أن يقوم بتنفيذها خلال اليوم\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ م٣ / يوم \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview412.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview412)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview411.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview411)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview410.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview410)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview424.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview424)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview423.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview423)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* عدد أيام\nالعمل التي\nسيتم استخدام\nتنك أو نقلة\nمياه بها\nلزوم تنفيذ\nالبند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview422.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview422)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview428.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview428)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview427.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview427)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview426.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview426)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview440.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview440)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview439.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview439)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview438.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview438)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview443.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview443)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("اليومية\n( جنيه / يوم ) \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview442.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview442)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview441.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview441)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
			...
			public void onClick(View _view) {
				if (((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0)))) || ((edittext6.getText().toString().equals("") || edittext6.getText().toString().equals(".")) || (edittext6.getText().toString().equals("-") || (Double.parseDouble(edittext6.getText().toString()) < 0)))) || ((((edittext7.getText().toString().equals("") || edittext7.getText().toString().equals(".")) || edittext7.getText().toString().equals("-")) || ((edittext8.getText().toString().equals("") || edittext8.getText().toString().equals(".")) || edittext8.getText().toString().equals("-"))) || (((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))) || ((edittext111.getText().toString().equals("") || edittext111.getText().toString().equals(".")) || (edittext111.getText().toString().equals("-") || (Double.parseDouble(edittext111.getText().toString()) < 0)))))) {
					...
					if (((edittext113.getText().toString().equals("") || edittext113.getText().toString().equals(".")) || edittext113.getText().toString().equals("-")) || (Double.parseDouble(edittext113.getText().toString()) < 0)) {
						edittext113.setText(String.valueOf(0.00));
					}
					...
					if ((Double.parseDouble(edittext113.getText().toString()) == 00.00d) || (Double.parseDouble(edittext114.getText().toString()) == 00.00d)) {
						...
						edittext116.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext17.getText().toString()) / (Double.parseDouble(edittext113.getText().toString()) * Double.parseDouble(edittext114.getText().toString())))));
						edittext117.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext17.getText().toString()) / Double.parseDouble(edittext113.getText().toString()))));
						edittext118.setText(String.valueOf(Double.parseDouble(edittext117.getText().toString()) * Double.parseDouble(edittext115.getText().toString())));
					}
					edittext116.setTextColor(0xFF000000);
					edittext117.setTextColor(0xFF000000);
					edittext118.setTextColor(0xFF000000);
		...
		edittext117.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext117.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
		...
		edittext162.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext162.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 16)});
			}
		...
		edittext201.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext201.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 6)});
		...
		textview614.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview614)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview613.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview613)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview625.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview625)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nفنشر أساس \n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		edittext216.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				edittext217.setText(String.valueOf(00.00));
				edittext237.setText(String.valueOf(00.00));
				edittext238.setText(String.valueOf(00.00));
				edittext217.setTextColor(0xFFE91E63);
				edittext237.setTextColor(0xFFE91E63);
				edittext238.setTextColor(0xFFE91E63);
			}
		...
		textview624.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview624)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد فنشارات الأساس\nالمستخدمة\nوفي حالة عدم استخدام فنشر أساس يتم وضع القيمة = ٠\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠ \"\nبمعني أنه غير موجود أو غير أساسي لتنفيذ البند")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview610.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview610)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالجريدر\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview609.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview609)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview619.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview619)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقلة\nللتانك شامل\nتوريد المياه\n( جنيه / نقلة )\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview618.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview618)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview622.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview622)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالهراس\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview621.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview621)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview631.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview631)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview630.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview630)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview633.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview633)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview632.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview632)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button12.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0)))) || ((edittext6.getText().toString().equals("") || edittext6.getText().toString().equals(".")) || (edittext6.getText().toString().equals("-") || (Double.parseDouble(edittext6.getText().toString()) < 0)))) || ((((edittext7.getText().toString().equals("") || edittext7.getText().toString().equals(".")) || (edittext7.getText().toString().equals("-") || (Double.parseDouble(edittext7.getText().toString()) < 0))) || ((edittext8.getText().toString().equals("") || edittext8.getText().toString().equals(".")) || (edittext8.getText().toString().equals("-") || (Double.parseDouble(edittext8.getText().toString()) < 0)))) || ((((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))) || ((edittext201.getText().toString().equals("") || edittext201.getText().toString().equals(".")) || (edittext201.getText().toString().equals("-") || (Double.parseDouble(edittext201.getText().toString()) < 0)))) || (((edittext203.getText().toString().equals("") || edittext203.getText().toString().equals(".")) || (edittext203.getText().toString().equals("-") || (Double.parseDouble(edittext203.getText().toString()) < 0))) || ((edittext202.getText().toString().equals("") || edittext202.getText().toString().equals(".")) || (edittext202.getText().toString().equals("-") || (Double.parseDouble(edittext202.getText().toString()) < 0))))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					edittext239.setText(String.valueOf(Double.parseDouble(edittext201.getText().toString()) - Double.parseDouble(edittext18.getText().toString())));
					edittext224.setText(String.valueOf(((Double.parseDouble(edittext201.getText().toString()) - Double.parseDouble(edittext18.getText().toString())) / Double.parseDouble(edittext18.getText().toString())) * 100));
					edittext239.setTextColor(0xFF000000);
					edittext224.setTextColor(0xFF000000);
					edittext232.setText(String.valueOf(Double.parseDouble(edittext201.getText().toString()) * Double.parseDouble(edittext202.getText().toString())));
					edittext232.setTextColor(0xFF000000);
					...
					edittext217.setText(String.valueOf(Double.parseDouble(edittext215.getText().toString()) * Double.parseDouble(edittext216.getText().toString())));
					edittext217.setTextColor(0xFF000000);
					...
					edittext235.setTextColor(0xFF000000);
					edittext237.setText(String.valueOf((((Double.parseDouble(edittext232.getText().toString()) + Double.parseDouble(edittext225.getText().toString())) + Double.parseDouble(edittext228.getText().toString())) + (Double.parseDouble(edittext217.getText().toString()) + Double.parseDouble(edittext227.getText().toString()))) + (((Double.parseDouble(edittext230.getText().toString()) + Double.parseDouble(edittext231.getText().toString())) + 0) + (Double.parseDouble(edittext234.getText().toString()) + Double.parseDouble(edittext235.getText().toString())))));
		...
		textview634.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadssActivity.this, textview634)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("نسبة الهالك\nوهي نسبة الهالك التي تحدث فعليآ بسبب النقل والتشغيل وخلافه")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		edittext217.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext217.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccBaseCourseLayersForRoadssActivity.this); //change the activity name
...
*/
		...
		/*
ميل طبقة الأحلال أو الردم
*/
		final TextView textview341d = dynamic_pipe_line_linear.findViewById(R.id.textview341d);
		textview341d.setText("ميل جوانب طبقة الأحلال أو الردم\n( الميل الجانبي لطبقات الأحلال والردم للطريق )");
		/*
...
*/
		...
		textview1423d.setText("محطة البداية\n( م )");
...
*/
		...
		textview613d.setText("محطة النهاية\n( م )");
...
*/
		...
		textview57d.setText("* سمك الطبقة\n( م )");
		textview57d.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
		...
		edittext6d.setBackgroundColor(0xFFC8E6C9);
		edittext6d.setHint("0.25");
		/*
عرض الطريق من الأعلي " عند منسوب تشطيب الطريق " ( م )
*/
		...
		textview59d.setText("عرض الطريق من الأعلي \" عند منسوب تشطيب الطريق \" ( م )");
		textview60d.setText("م");
		edittext4d.setBackgroundColor(0xFFBBDEFB);
		
		/*
عمق الطبقة أو بعد سطح الطبقة النهائي عن منسوب تشطيب الطريق ( م )
*/
		final TextView textview63d = dynamic_pipe_line_linear.findViewById(R.id.textview63d);
		final TextView textview64d = dynamic_pipe_line_linear.findViewById(R.id.textview64d);
		...
		textview63d.setText("عمق الطبقة أو بعد سطح الطبقة النهائي عن منسوب تشطيب الطريق ( م )");
		textview64d.setText("م");
		edittext5d.setBackgroundColor(0xFFBBDEFB);
...
*/
		...
		final EditText edittext301d = dynamic_pipe_line_linear.findViewById(R.id.edittext301d);
		edittext301d.setSingleLine(true);
		edittext301d.setFocusableInTouchMode(true);
		hscroll301d.setVisibility(View.VISIBLE);
		linear301d.setVisibility(View.VISIBLE);
		textview54d.setVisibility(View.GONE);
		/*
عرض الطبقة من الأعلي
( م )
*/
		...
		textview61d.setText("عرض الطبقة من الأعلي\n( م )");
		textview62d.setText("م");
		/*
عرض الطبقة من الأسفل
( م )
*/
		...
		textview111d.setText("عرض الطبقة من الأسفل\n( م )");
		textview511d.setText("م");
		/*
مسطح قطاع الطبقة
( م٢ )
*/
		final TextView textview112d = dynamic_pipe_line_linear.findViewById(R.id.textview112d);
		...
		textview112d.setText("مسطح قطاع الطبقة\n( م٢ )");
		/*
مسطح الطبقة من الأعلي
( م٢ )
*/
		final TextView textview113d = dynamic_pipe_line_linear.findViewById(R.id.textview113d);
		...
		textview113d.setText("مسطح الطبقة من الأعلي\n( م٢ )");
		/*
كمية طبقات الأحلال أو الردم الهندسية بدون انضغاط أو دمك ( م٣ )
*/
		final TextView textview114d = dynamic_pipe_line_linear.findViewById(R.id.textview114d);
		...
		textview114d.setText("كمية طبقة الأساس الهندسية بدون انضغاط أو دمك ( م٣ )");
		/*
ملاحظة فرق المنسوب
*/
...
edittext15d.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 7)});
				edittext301d.setText(String.valueOf(00.00));
				edittext301d.setTextColor(0xFFE91E63);
...
edittext8d.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 6)});
		...
		button2d.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext4d.getText().toString().equals("") || edittext4d.getText().toString().equals(".")) || (edittext4d.getText().toString().equals("-") || (Double.parseDouble(edittext4d.getText().toString()) < 0))) || ((edittext5d.getText().toString().equals("") || edittext5d.getText().toString().equals(".")) || (edittext5d.getText().toString().equals("-") || (Double.parseDouble(edittext5d.getText().toString()) < 0)))) || ((((edittext7d.getText().toString().equals("") || edittext7d.getText().toString().equals(".")) || edittext7d.getText().toString().equals("-")) || ((edittext8d.getText().toString().equals("") || edittext8d.getText().toString().equals(".")) || edittext8d.getText().toString().equals("-"))) || (((edittext15d.getText().toString().equals("") || edittext15d.getText().toString().equals(".")) || (edittext15d.getText().toString().equals("-") || (Double.parseDouble(edittext15d.getText().toString()) < 0))) || ((edittext2d.getText().toString().equals("") || edittext2d.getText().toString().equals(".")) || (edittext2d.getText().toString().equals("-") || (Double.parseDouble(edittext2d.getText().toString()) < 0)))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					...
					edittext301d.setText(String.valueOf(Double.parseDouble(edittext2d.getText().toString()) - Double.parseDouble(edittext15d.getText().toString())));
					edittext301d.setTextColor(0xFF000000);
					if ((Double.parseDouble(edittext7d.getText().toString()) == 0) || (Double.parseDouble(edittext8d.getText().toString()) == 0)) {
						edittext199d.setText(String.valueOf(Double.parseDouble(edittext4d.getText().toString())));
						edittext9d.setText(String.valueOf(Double.parseDouble(edittext4d.getText().toString())));
					}
					else {
						edittext199d.setText(String.valueOf(((Double.parseDouble(edittext5d.getText().toString()) * (Double.parseDouble(edittext7d.getText().toString()) / Double.parseDouble(edittext8d.getText().toString()))) + Double.parseDouble(edittext4d.getText().toString())) + (Double.parseDouble(edittext5d.getText().toString()) * (Double.parseDouble(edittext7d.getText().toString()) / Double.parseDouble(edittext8d.getText().toString())))));
						edittext9d.setText(String.valueOf(((Double.parseDouble(edittext6d.getText().toString()) * (Double.parseDouble(edittext7d.getText().toString()) / Double.parseDouble(edittext8d.getText().toString()))) + Double.parseDouble(edittext199d.getText().toString())) + (Double.parseDouble(edittext6d.getText().toString()) * (Double.parseDouble(edittext7d.getText().toString()) / Double.parseDouble(edittext8d.getText().toString())))));
					}
					edittext199d.setTextColor(0xFF000000);
					edittext9d.setTextColor(0xFF000000);
					edittext10d.setText(String.valueOf(((Double.parseDouble(edittext199d.getText().toString()) + Double.parseDouble(edittext9d.getText().toString())) / 2) * Double.parseDouble(edittext6d.getText().toString())));
					edittext10d.setTextColor(0xFF000000);
					if (Double.parseDouble(edittext301d.getText().toString()) < 0) {
						textview54d.setVisibility(View.VISIBLE);
						edittext11d.setText(String.valueOf(0.00d));
						edittext12d.setText(String.valueOf(0.00d));
					}
					else {
						textview54d.setVisibility(View.GONE);
						edittext11d.setText(String.valueOf(Double.parseDouble(edittext199d.getText().toString()) * Double.parseDouble(edittext301d.getText().toString())));
						edittext12d.setText(String.valueOf(Double.parseDouble(edittext301d.getText().toString()) * Double.parseDouble(edittext10d.getText().toString())));
		...
		edittext301d.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
		...
		edittext10d.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
		...
		/*
إجمالي مسطح الطبقة من الأعلي ميكانيكي
*/
			...
			public void afterTextChanged(Editable s) { 	
				...
				temp = 0;
				 for(int i=0; i<dynamic_pipe_line.getChildCount(); ++i) { 
					...
					TextView tempo =child.findViewById(R.id.edittext11d);
					temp = temp + Double.parseDouble(tempo.getText().toString());
				}
				edittext14.setText(String.valueOf(temp));
			} });
		/*
إجمالي كمية طبقات الأحلال أو الردم الهندسية بدون انضغاط أو دمك ميكانيكي
*/
