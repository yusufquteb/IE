...
public class CivilExecutionConstructionMenuActivity extends AppCompatActivity {

    private static final String[] TITLES = {
        "استلام بند الحفر",
        "استلام بند الأحلال",
        "استلام بند القواعد العادية"
    };

    private static final Class<?>[] TARGETS = {
        EipexcavationsActivity.class,
        EipreplacementsActivity.class,
        EipplainconcretefootingsActivity.class
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("التنفيذ - الإنشاءات");
    ...
    private class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull VH holder, int pos) {
            ...
            holder.card.setOnClickListener(v -> startActivity(new Intent(CivilExecutionConstructionMenuActivity.this, TARGETS[pos])));
        }
