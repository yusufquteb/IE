...
public class ToipccReplacementLayerForRoadActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_replacement_layer_for_road);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				drainage_pipe_line.setClass(getApplicationContext(), ToipccReplacementLayerForRoadsActivity.class);
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccReplacementLayerForRoadActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccReplacementLayerForRoadActivity.this.getSystemService(PRINT_SERVICE);
