...
public class ToipccPlasteringssActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_plasteringss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview1509 = findViewById(R.id.textview1509);
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/_MBNk3Pfn4U"));
				startActivity(price);
			}
		});
		...
		L1.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, L1)
				        .autoHide(true, 5000)
		...
		textview1484.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, textview1484)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1487.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, textview1487)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1490.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, textview1490)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1405.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, textview1405)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1419.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlasteringssActivity.this, textview1419)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
...
*/
		...
		d_textview55.setText("المسطح الأجمالي لبياض جميع الأسقف من هذا النموذج أقل من المسطح الاجمالى لجميع الفتحات");
		/*
...
*/
		...
		d_textview6.setText("مسطح البياض للسقف الواحد من هذا النموذج بدون خصم الفتحات ( م٢ )");
		d_textview7.setText("اجمالي المسطحات لبياض جميع الأسقف من هذا النموذج بدون خصم الفتحات ( م٢ )");
		d_textview511.setText("م٢");
		d_textview9.setText("المسطح الأجمالي لبياض جميع الأسقف من هذا النموذج بعد خصم الفتحات ( م٢ )");
...
*/
		d_close_wall.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				/*
إجمالي كميات البياض الدينامك بعد عملية الحذف م٢
*/
				temp = 0;
				 for(int i=0; i<add_dynamic_wall_linear.getChildCount(); ++i) { 
					 View child=add_dynamic_wall_linear.getChildAt(i); 
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccPlasteringssActivity.this); //change the activity name
			...
			public void afterTextChanged(Editable s) { 	
				...
				if (Double.parseDouble(edittext1.getText().toString()) < temp1a) {
					...
					if (Double.parseDouble(edittext2.getText().toString()) < temp2b) {
						...
						edittext4.setText(String.valueOf(Double.parseDouble(edittext1.getText().toString()) * Double.parseDouble(edittext2.getText().toString())));
						edittext4.setTextColor(0xFF000000);
						edittext5.setText(String.valueOf(Double.parseDouble(edittext4.getText().toString()) * Double.parseDouble(edittext3.getText().toString())));
						edittext5.setTextColor(0xFF000000);
					}
				}
			} });
