...
public class ToipccAsphaltRoadMillingMachineActivity extends AppCompatActivity {
	...
	private TextView textview2322;
	private LinearLayout linear1024;
	private TextView textview2323;
	...
	private HorizontalScrollView hscroll123;
	private LinearLayout linear1027;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_asphalt_road_milling_machine);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview2322 = findViewById(R.id.textview2322);
		linear1024 = findViewById(R.id.linear1024);
		textview2323 = findViewById(R.id.textview2323);
		...
		hscroll123 = findViewById(R.id.hscroll123);
		linear1027 = findViewById(R.id.linear1027);
		...
		textview2321 = findViewById(R.id.textview2321);
		...
		textview2324 = findViewById(R.id.textview2324);
		edittext206 = findViewById(R.id.edittext206);
		textview2325 = findViewById(R.id.textview2325);
		...
		textview10.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* سمك الطبقة المراد كشطها\n( م )\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٥ م \"");
				return true;
			}
		});
			...
			public void onClick(View _view) {
				if ((((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0))) || ((edittext3.getText().toString().equals("") || edittext3.getText().toString().equals(".")) || (edittext3.getText().toString().equals("-") || (Double.parseDouble(edittext3.getText().toString()) < 0)))) || ((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(". ")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0)))) {
					...
					if (Double.parseDouble(edittext6.getText().toString()) < 0) {
						...
						edittext13.setText(String.valueOf(Double.parseDouble(edittext7.getText().toString()) * Double.parseDouble(edittext5.getText().toString())));
					}
...
*/
		...
		textview1264.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* نسبة الأنتفاش\nوهي تعبر عن النسبة التي ينتفش بها ناتج الكشط عند تحميله بالعربيات لنقله للمقالب العمومية\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة ٣٠ % \" وذلك عند الضغط علي زرار أحسب");
				return true;
			}
		});
...
*/
		...
		button8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				if (SketchwareUtil.isConnected(getApplicationContext())) {
					...
					edittext201.setText("");
					edittext202.setText("");
					edittext203.setTextColor(0xFF000000);
					edittext205.setText("");
					edittext204.setText("");
					edittext206.setTextColor(0xFF000000);
					edittext207.setTextColor(0xFF000000);
					edittext208.setTextColor(0xFF000000);
					edittext211.setText("");
					edittext212.setText("");
		...
		button10.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((edittext34.getText().toString().equals("") || edittext34.getText().toString().equals(".")) || (edittext34.getText().toString().equals("-") || (Double.parseDouble(edittext34.getText().toString()) < 0))) || ((edittext35.getText().toString().equals("") || edittext35.getText().toString().equals(".")) || (edittext35.getText().toString().equals("-") || (Double.parseDouble(edittext35.getText().toString()) < 0)))) {
					...
					edittext37.setText(String.valueOf(Double.parseDouble(edittext24.getText().toString()) * Double.parseDouble(edittext34.getText().toString())));
		...
		textview475.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview475)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالمكشطة\n( جنيه / يوم )\nوهو يعبر عن المبلغ الذي تتقاضاه المكشطة بنهاية اليوم عن الأعمال التي قام بتنفيذها خلال اليوم ")
		...
		textview473.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* عدد المكشطة المستخدم بالبند خلال اليوم\n( مكشطة / يوم )\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ مكشطة / يوم \"");
				return true;
			}
		});
		...
		textview420.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview420)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقل\n( جنيه / م٣ )\nوهو يعبر عن المبلغ الذي يتكلفة النقل لمخلفات عملية الكشط من موقع العمل الي المقالب العمومية بالجنيه لكل ١م٣")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview418.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* حمولة\nالسيارة\n( م٣ )\n\nوهو يعبر عن الكمية التي يمكن تقوم السيارة النقل بحملها ونقلها من الخلاطة لموقع العمل \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٢٠ م٣ \"");
				return true;
			}
		});
		...
		textview428.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview428)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview427.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview427)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview426.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview426)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1206.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1206)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1207.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1207)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview1208.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1208)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1150.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1150)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1151.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1151)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview1152.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview1152)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview440.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview440)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview439.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview439)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview438.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview438)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview443.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview443)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("اليومية\n( جنيه / يوم ) \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview442.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview442)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview441.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview441)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button11.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((edittext112.getText().toString().equals("") || edittext112.getText().toString().equals(".")) || (edittext112.getText().toString().equals("-") || (Double.parseDouble(edittext112.getText().toString()) < 0))) || (((edittext139.getText().toString().equals("") || edittext139.getText().toString().equals(".")) || edittext139.getText().toString().equals("-")) || (Double.parseDouble(edittext139.getText().toString()) < 0))) {
					...
					edittext140.setTextColor(0xFF000000);
					if (((edittext110.getText().toString().equals("") || edittext110.getText().toString().equals(".")) || edittext110.getText().toString().equals("-")) || (Double.parseDouble(edittext110.getText().toString()) < 0)) {
						edittext110.setText(String.valueOf(20));
					}
					if (((edittext111.getText().toString().equals("") || edittext111.getText().toString().equals(".")) || edittext111.getText().toString().equals("-")) || (Double.parseDouble(edittext111.getText().toString()) < 0)) {
						edittext111.setText(String.valueOf(1));
					}
					if ((Double.parseDouble(edittext110.getText().toString()) == 00.00d) || (Double.parseDouble(edittext111.getText().toString()) == 00.00d)) {
						edittext113.setText(String.valueOf(00.00));
						edittext114.setText(String.valueOf(00.00));
						edittext115.setText(String.valueOf(00.00));
					}
					else {
						edittext113.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext28.getText().toString()) / (Double.parseDouble(edittext110.getText().toString()) * Double.parseDouble(edittext111.getText().toString())))));
						edittext114.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext28.getText().toString()) / Double.parseDouble(edittext110.getText().toString()))));
						edittext115.setText(String.valueOf(Double.parseDouble(edittext112.getText().toString()) * Double.parseDouble(edittext28.getText().toString())));
					}
					edittext113.setTextColor(0xFF000000);
					edittext114.setTextColor(0xFF000000);
					edittext115.setTextColor(0xFF000000);
					...
					if (((edittext125.getText().toString().equals("") || edittext125.getText().toString().equals(".")) || edittext125.getText().toString().equals("-")) || (Double.parseDouble(edittext125.getText().toString()) < 0)) {
						edittext125.setText(String.valueOf(1));
					}
		...
		edittext114.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext114.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
		...
		edittext115.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext115.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 9)});
			}
		...
		textview625.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview625)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		edittext201.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				edittext203.setText(String.valueOf(00.00));
				edittext203.setTextColor(0xFFE91E63);
		...
		textview624.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview624)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد المكشطة\nالمستخدمة\nوفي حالة عدم استخدام المكشطة يتم وضع القيمة = ٠\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ١ مكشطة \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview2321.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview2321)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر نقل ناتج الكشط\n( جنيه / م٣ )\nوهو يعبر عن سعر نقل ١ م٣ من ناتج الكشط من موقع العمل الي المقالب العمومية بالجنيه لكل ١م٣")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		edittext204.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				edittext208.setText(String.valueOf(00.00));
				edittext208.setTextColor(0xFFE91E63);
				edittext240.setText(String.valueOf(00.00));
				edittext240.setTextColor(0xFFE91E63);
				edittext241.setText(String.valueOf(00.00));
				edittext241.setTextColor(0xFFE91E63);
		...
		textview641.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview641)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* كمية الكشط\nالفعلية التي\nتم نقلها\n( م٣ )\n\nوهو يعبر عن الكمية التي تم نقلها من موقع العمل الي المقالب العمومية\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٢٠ م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		edittext205.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				edittext206.setText(String.valueOf(00.00));
				edittext207.setText(String.valueOf(00.00));
				edittext206.setTextColor(0xFFE91E63);
				edittext207.setTextColor(0xFFE91E63);
				edittext208.setText(String.valueOf(00.00));
				edittext208.setTextColor(0xFFE91E63);
				edittext240.setText(String.valueOf(00.00));
				edittext240.setTextColor(0xFFE91E63);
		...
		textview619.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview619)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview618.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview618)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview622.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview622)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview621.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview621)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview627.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview627)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* يومية\nالجرار أو\nالسيارة\nاللازمة لجر\nالكومبرسور\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview626.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview626)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview640.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview640)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* يومية\nالكومبرسور\n\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview639.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview639)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview631.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview631)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview630.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview630)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview633.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview633)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالمعدة\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview632.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccAsphaltRoadMillingMachineActivity.this, textview632)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد المعدات الأخري أو العمالة\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		button12.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0))) || ((edittext3.getText().toString().equals("") || edittext3.getText().toString().equals(".")) || (edittext3.getText().toString().equals("-") || (Double.parseDouble(edittext3.getText().toString()) < 0)))) || (((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || (((edittext201.getText().toString().equals("") || edittext201.getText().toString().equals(".")) || (edittext201.getText().toString().equals("-") || (Double.parseDouble(edittext201.getText().toString()) < 0))) || (((edittext204.getText().toString().equals("") || edittext204.getText().toString().equals(".")) || (edittext204.getText().toString().equals("-") || (Double.parseDouble(edittext204.getText().toString()) < 0))) || ((edittext205.getText().toString().equals("") || edittext205.getText().toString().equals(".")) || (edittext205.getText().toString().equals("-") || (Double.parseDouble(edittext205.getText().toString()) < 0))))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					if ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0))) {
					...
					if ((edittext202.getText().toString().equals("") || edittext202.getText().toString().equals(".")) || (edittext202.getText().toString().equals("-") || (Double.parseDouble(edittext202.getText().toString()) < 0))) {
						edittext202.setText(String.valueOf(1));
					}
					edittext203.setText(String.valueOf(Double.parseDouble(edittext201.getText().toString()) * Double.parseDouble(edittext202.getText().toString())));
					edittext203.setTextColor(0xFF000000);
					edittext206.setText(String.valueOf(Double.parseDouble(edittext205.getText().toString()) - Double.parseDouble(edittext25.getText().toString())));
					edittext207.setText(String.valueOf(((Double.parseDouble(edittext205.getText().toString()) - Double.parseDouble(edittext25.getText().toString())) / Double.parseDouble(edittext25.getText().toString())) * 100));
					edittext208.setText(String.valueOf(Double.parseDouble(edittext205.getText().toString()) * Double.parseDouble(edittext204.getText().toString())));
					edittext206.setTextColor(0xFF000000);
					edittext207.setTextColor(0xFF000000);
					edittext208.setTextColor(0xFF000000);
					...
					edittext238.setTextColor(0xFF000000);
					edittext240.setText(String.valueOf(((Double.parseDouble(edittext203.getText().toString()) + Double.parseDouble(edittext208.getText().toString())) + (Double.parseDouble(edittext231.getText().toString()) + Double.parseDouble(edittext232.getText().toString()))) + ((Double.parseDouble(edittext233.getText().toString()) + Double.parseDouble(edittext234.getText().toString())) + (Double.parseDouble(edittext237.getText().toString()) + Double.parseDouble(edittext238.getText().toString())))));
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccAsphaltRoadMillingMachineActivity.this); //change the activity name
	...
	public void _asphlt_road_milling() {
...
*/
		...
		textview10d.setText("* سمك الطبقة المراد كشطها\n( م )");
...
*/
		...
		/*
كمية الطبقة الإجمالية أو كمية الأسفلت الهندسية الأجمالية ( م٣ )
*/
		final LinearLayout linear7d = ll_mainDynamic.findViewById(R.id.linear7d);
		linear7d.setVisibility(View.GONE);
		final LinearLayout linear19d = ll_mainDynamic.findViewById(R.id.linear19d);
		linear19d.setVisibility(View.GONE);
		final HorizontalScrollView hscroll6d = ll_mainDynamic.findViewById(R.id.hscroll6d);
		hscroll6d.setVisibility(View.GONE);
		/*
كمية الكشط بهذا القطاع ( م٣ )
*/
			...
			public void onClick(View _view) {
				if ((((edittext2d.getText().toString().equals("") || edittext2d.getText().toString().equals(".")) || (edittext2d.getText().toString().equals("-") || (Double.parseDouble(edittext2d.getText().toString()) < 0))) || ((edittext3d.getText().toString().equals("") || edittext3d.getText().toString().equals(".")) || (edittext3d.getText().toString().equals("-") || (Double.parseDouble(edittext3d.getText().toString()) < 0)))) || ((edittext4d.getText().toString().equals("") || edittext4d.getText().toString().equals(". ")) || (edittext4d.getText().toString().equals("-") || (Double.parseDouble(edittext4d.getText().toString()) < 0)))) {
					...
					if (Double.parseDouble(edittext6d.getText().toString()) < 0) {
						...
						edittext13d.setText(String.valueOf(Double.parseDouble(edittext7d.getText().toString()) * Double.parseDouble(edittext5d.getText().toString())));
					}
