...
public class ToipccreinforcedconcretecolumnActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipccreinforcedconcretecolumn);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				TechnicalOffice.setClass(getApplicationContext(), ToipccreinforcedconcretecolumnsActivity.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				TechnicalOffice.setClass(getApplicationContext(), ToipccreinforcedconcretecolumnssActivity.class);
				startActivity(TechnicalOffice);
			}
		});
	}
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccreinforcedconcretecolumnActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccreinforcedconcretecolumnActivity.this.getSystemService(PRINT_SERVICE);
