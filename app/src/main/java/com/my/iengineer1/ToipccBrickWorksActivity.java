...
public class ToipccBrickWorksActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_brick_works);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/zTLPDwpakkE"));
				startActivity(price);
			}
		});
			...
			public void onClick(View _view) {
				if (((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (edittext1.getText().toString().equals("-") || (Double.parseDouble(edittext1.getText().toString()) < 0))) || ((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0)))) {
					...
					if ((edittext22.getText().toString().equals("") || edittext22.getText().toString().equals(".")) || (edittext22.getText().toString().equals("-") || (Double.parseDouble(edittext22.getText().toString()) < 0))) {
						edittext22.setText(String.valueOf(0.12d));
					}
		...
		edittext23.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext23.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 6)});
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ((((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (edittext1.getText().toString().equals("-") || (Double.parseDouble(edittext1.getText().toString()) < 0))) || ((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0)))) || (((edittext22.getText().toString().equals("") || edittext22.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0))) || ((edittext3.getText().toString().equals("") || edittext3.getText().toString().equals(".")) || (edittext3.getText().toString().equals("-") || (Double.parseDouble(edittext3.getText().toString()) < 0))))) {
					...
					edittext30.setText(String.valueOf(Double.parseDouble(edittext23.getText().toString()) / (((Double.parseDouble(edittext24.getText().toString()) + Double.parseDouble(edittext27.getText().toString())) / 100) * (((Double.parseDouble(edittext26.getText().toString()) + Double.parseDouble(edittext27.getText().toString())) / 100) * (Double.parseDouble(edittext25.getText().toString()) / 100)))));
					...
					edittext33.setText(String.valueOf(Double.parseDouble(edittext30.getText().toString()) * ((((Double.parseDouble(edittext24.getText().toString()) + Double.parseDouble(edittext27.getText().toString())) / 100) * ((Double.parseDouble(edittext25.getText().toString()) / 100) * (Double.parseDouble(edittext27.getText().toString()) / 100))) + ((Double.parseDouble(edittext25.getText().toString()) / 100) * ((Double.parseDouble(edittext26.getText().toString()) / 100) * (Double.parseDouble(edittext27.getText().toString()) / 100))))));
		...
		textview196.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview196)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("طول الطوبة ( سم ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٢٥ سم \"")
		...
		textview90.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview90)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عرض الطوبة ( سم ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١٢ سم \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview377.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview377)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إرتفاع الطوبة ( سم ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٦ سم \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview260.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview260)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("سمك العرموس \" سمك عرموس\nالربط بين الطوب \" ( سم ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ سم \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview232.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview232)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("نسبة الأسمنت بمونة الربط\nواللصق [ المحتوي الأسمنتي ] ( كجم / م٣رمل ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بافتراضه بقيمة = ٣٠٠ كجم / م٣ رمل \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview234.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview234)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* نسبة الهالك للطوب \" ناتج قابل للتعديل في حالة الرغبة وفي حالة عدم الرغبة سيقوم البرنامج بافتراضه بقيمة = ١٠% \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview1405.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview1405)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* نسبة الهالك بالأسمنت \" ناتج قابل للتعديل في حالة الرغبة وفي حالة عدم الرغبة سيقوم البرنامج بافتراضه بقيمة = ٥% \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview1419.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview1419)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1455.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBrickWorksActivity.this, textview1455)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* تكلفة المسامير وزوايا الربط بالمباني \" ان وجدت \" ( جنيه )\nمدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بتجاهل حسابه أثناء حساب التكلفة")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
			...
			public void onClick(View _view) {
				if (((d_edittext1.getText().toString().equals("") || d_edittext1.getText().toString().equals(".")) || (d_edittext1.getText().toString().equals("-") || (Double.parseDouble(d_edittext1.getText().toString()) < 0))) || ((d_edittext2.getText().toString().equals("") || d_edittext2.getText().toString().equals(".")) || (d_edittext2.getText().toString().equals("-") || (Double.parseDouble(d_edittext2.getText().toString()) < 0)))) {
					...
					if ((d_edittext22.getText().toString().equals("") || d_edittext22.getText().toString().equals(".")) || (d_edittext22.getText().toString().equals("-") || (Double.parseDouble(d_edittext22.getText().toString()) < 0))) {
						d_edittext22.setText(String.valueOf(0.12d));
					}
					...
					d_edittext5.setText(String.valueOf(Double.parseDouble(d_edittext22.getText().toString()) * Double.parseDouble(d_edittext4.getText().toString())));
