...
public class EipCheckSewageLinesReplacementsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eip_check_sewage_lines_replacements);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/cUhxO3JyTRU"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesReplacementsActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesReplacementsActivity.this.getSystemService(PRINT_SERVICE);
...
*/
		...
		button2dw.setText("أضافة فحص واستلام عرض طبقة أحلال جديد");
		button5dl.setText("أضافة فحص واستلام منسوب طبقة أحلال جديد");
		/*
LinearLayout
*/
...
*/
		...
		textview26d.setText("قراءة القامة لمنسوب ظهر الأحلال عند النقطة التصميمية او عند المطبق التصميمي المراد رفع واستلام الفرعة عنده");
		/*
...
*/
		...
		textview13d.setText("منسوب سطح الأحلال للفرعة عند النقطة التصميمية او عند المطبق التصميمي المراد رفع واستلام الفرعة من عنده");
		textview14d.setText("عرض قاع الحفر التصميمي ( طبقة الأحلال من الأسفل )\n( م )");
		...
		textview107d.setText("أولآ فحص واستلام عرض طبقة الأحلال من الأعلي :-");
		textview108d.setText("ثانيآ فحص واستلام منسوب سطح طبقة الأحلال من الأعلي :-");
		/*
...
*/
		...
		textview41d.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				dialog.setTitle("* ميل جوانب طبقة الأحلال فى الأتجاه الأفقي");
		...
		textview42d.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				dialog.setTitle("* ميل جوانب طبقة الأحلال فى الأتجاه الراسي");
				dialog.setMessage("مدخل اختياري في حالة عدم إدخاله سيقوم البرنامج بافتراضه بقيمة = ٠.٠٠\nمما يعني راسية الحفر وعدم وجود ميول جانبية");
				dialog.setPositiveButton("ok", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
...
if ((edittext_am9d.getText().toString().equals("a.m") || (Double.parseDouble(edittext14d.getText().toString()) == 00.00d)) || (edittext_am42d.getText().toString().equals("a.m") || edittext_am41dnn.equals("a.m"))) {
					edittext43d.setText(String.valueOf(Double.parseDouble(edittext14d.getText().toString())));
				}
				else {
					edittext43d.setText(_English_Decimal_Format(((Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41dnn) / Double.parseDouble(edittext_am42d.getText().toString()))) + Double.parseDouble(edittext14d.getText().toString())) + (Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41dnn) / Double.parseDouble(edittext_am42d.getText().toString())))));
				}
						}
...
if ((edittext_am9d.getText().toString().equals("a.m") || (Double.parseDouble(edittext14d.getText().toString()) == 00.00d)) || (edittext_am41d.getText().toString().equals("a.m") || edittext_am42dnn.equals("a.m"))) {
					edittext43d.setText(String.valueOf(Double.parseDouble(edittext14d.getText().toString())));
				}
				else {
					edittext43d.setText(_English_Decimal_Format(((Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42dnn))) + Double.parseDouble(edittext14d.getText().toString())) + (Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42dnn)))));
				}
						}
...
if (edittext_am8dnn.equals("a.m")) {
					edittext13d.setText(String.valueOf(0.00d));
					edittext_am13d.setText("");
				}
				else {
					edittext13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8dnn)));
					edittext_am13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8dnn)));
				}
						}
...
if ((edittext_am9dnn.equals("a.m") || (Double.parseDouble(edittext14d.getText().toString()) == 00.00d)) || (edittext_am41d.getText().toString().equals("a.m") || edittext_am42d.getText().toString().equals("a.m"))) {
					edittext43d.setText(String.valueOf(Double.parseDouble(edittext14d.getText().toString())));
				}
				else {
					edittext43d.setText(_English_Decimal_Format(((Double.parseDouble(edittext_am9dnn) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42d.getText().toString()))) + Double.parseDouble(edittext14d.getText().toString())) + (Double.parseDouble(edittext_am9dnn) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42d.getText().toString())))));
				}
						}
...
if (edittext_am11d.getText().toString().contains("a.m") || edittext_am12dnn.contains("a.m")) {
		...
		button1d.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((edittext_am3d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am8d.getText().toString().equals("a.m"))) || ((edittext_am10d.getText().toString().equals("a.m") || edittext_am11d.getText().toString().equals("a.m")) || edittext_am12d.getText().toString().equals("a.m"))) {
...
if ((edittext_am9d.getText().toString().equals("a.m") || (Double.parseDouble(edittext14dnn) == 00.00d)) || (edittext_am41d.getText().toString().equals("a.m") || edittext_am42d.getText().toString().equals("a.m"))) {
					edittext43d.setText(String.valueOf(Double.parseDouble(edittext14dnn)));
				}
				else {
					edittext43d.setText(_English_Decimal_Format(((Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42d.getText().toString()))) + Double.parseDouble(edittext14dnn)) + (Double.parseDouble(edittext_am9d.getText().toString()) * (Double.parseDouble(edittext_am41d.getText().toString()) / Double.parseDouble(edittext_am42d.getText().toString())))));
				}
						}
...
*/
					...
					textview111dw.setText("عرض سطح الأحلال الفعلي من الأعلي المقاس علي الطبيعة يساوي عرض سطح الأحلال التصميمي المحسوب طبقا للميول الجانبية\nالعرض مطابق");
					final TextView textview112dw = dynamic_pipe_line_check_excavation_width.findViewById(R.id.textview112dw);
					textview112dw.setText("عرض سطح الأحلال الفعلي من الأعلي المقاس علي الطبيعة أقل من عرض سطح الأحلال التصميمي المحسوب طبقا للميول الجانبية\nوعليه يرجي زيادة عرض الحفر بقدار الفرق\nملاحظة : ( ve - ) توضح ان عرض الحفر ناقص وانه يجب زيادة عرض الحفر بالمقدار المجاور للعلامة");
					final TextView textview113dw = dynamic_pipe_line_check_excavation_width.findViewById(R.id.textview113dw);
					textview113dw.setText("عرض سطح الأحلال الفعلي من الأعلي المقاس علي الطبيعة أكبر من عرض سطح الأحلال التصميمي المحسوب طبقا للميول الجانبية\nوعليه ستتكلف أعمال أحلال بكميات أضافية");
					/*
TextView
*/
					final TextView textview16dw = dynamic_pipe_line_check_excavation_width.findViewById(R.id.textview16dw);
					textview16dw.setText("عرض سطح الأحلال من الأعلي المقاس علي الطبيعة\n( م )");
					final TextView textview17dw = dynamic_pipe_line_check_excavation_width.findViewById(R.id.textview17dw);
					textview17dw.setText("الفرق ( م )\n( عرض سطح الأحلال من الأعلي المقاس علي الطبيعة\n-\nالعرض التصميمي عند سطح الأحلال )");
					/*
ثانيآ المدخلات والمعادلات
*/
...
*/
					...
					textview121dl.setText("منسوب سطح الأحلال الفعلي للنقطة المرصودة يساوي منسوب سطح الأحلال التصميمي عند نفس النقطة");
					textview122dl.setVisibility(View.GONE);
					textview122dl.setText("منسوب سطح الأحلال الفعلي للنقطة المرصودة أوطي من منسوب سطح الأحلال التصميمي عند نفس النقطة\nوعليه يلزم زيادة منسوب الأحلال بمقدار الفرق\nملاحظة : ( ve - ) توضح ان سمك الأحلال ناقص وانه يجب زيادة سمك ومنسوب الأحلال بالمقدار المجاور للعلامة للوصول للمنسوب التصميمي");
					textview123dl.setVisibility(View.GONE);
					textview123dl.setText("منسوب سطح الأحلال الفعلي للنقطة المرصودة أعلي من منسوب سطح الأحلال التصميمي عند نفس النقطة\nوعليه يلزم قطع وانقاص وتخفيض منسوب الأحلال بمقدار الفرق للوصول للمنسوب التصميمي");
...
*/
					...
					textview20dl.setText("منسوب سطح الأحلال التصميمي عند النقطة المرصودة");
					textview21dl.setText("منسوب سطح الأحلال الفعلي عند النقطة المرصودة");
					textview22dl.setText("الفرق\n( منسوب سطح الأحلال الفعلي عند النقطة المرصودة\n-\nمنسوب سطح الأحلال التصميمي عند نفس النقطة المرصوده  ) \n( م )");
					/*
EditText لزوم القراءات
*/
					...
					textview27dl.setText("قراءة القامة لمنسوب ظهر الأحلال التصميمي عند النقطة المرصودة");
...
if ((edittext_am10dnn.equals("a.m") || edittext_am18dl.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || edittext_am9d.getText().toString().equals("a.m"))) {
...
if ((edittext_am10d.getText().toString().equals("a.m") || edittext_am18dl.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || edittext_am9d.getText().toString().equals("a.m"))) {
										edittext20dl.setText(String.valueOf(00.00d));
										edittext_am20dl.setText("a.m");
									}
									else {
...
if ((edittext_am10d.getText().toString().equals("a.m") || edittext_am18dlnn.equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || edittext_am9d.getText().toString().equals("a.m"))) {
										edittext20dl.setText(String.valueOf(00.00d));
										edittext_am20dl.setText("a.m");
									}
									else {
...
if (((((edittext_am18dl.getText().toString().equals("a.m") || textview118d.getVisibility() == View.VISIBLE) || (textview119dl.getVisibility() == View.VISIBLE || textview120dl.getVisibility() == View.VISIBLE)) || edittext_am10d.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || edittext_am9d.getText().toString().equals("a.m"))) || (edittext_am19dl.getText().toString().equals("a.m") || (edittext_am11d.getText().toString().equals("a.m") || edittext_am12d.getText().toString().equals("a.m")))) {
...
if ((edittext_am10d.getText().toString().equals("a.m") || (edittext_am8d.getText().toString().equals("a.m") || edittext_am9d.getText().toString().equals("a.m"))) || edittext_am18dl.getText().toString().equals("a.m")) {
										edittext20dl.setText(String.valueOf(00.00d));
										edittext_am20dl.setText("a.m");
									}
									else {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام طبقة الأحلال أسفل المواسير لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط والميل التصميمي للفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
