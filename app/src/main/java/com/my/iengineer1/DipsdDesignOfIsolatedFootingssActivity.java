...
public class DipsdDesignOfIsolatedFootingssActivity extends AppCompatActivity {
	...
	private LinearLayout linear2469;
	...
	private LinearLayout linear2472;
	...
	private LinearLayout linear2473;
	private LinearLayout linear2474;
	...
	private RequestNetwork design_isolated_footings;
	private RequestNetwork.RequestListener _design_isolated_footings_request_listener;
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.dipsd_design_of_isolated_footingss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear2469 = findViewById(R.id.linear2469);
		...
		linear2472 = findViewById(R.id.linear2472);
		...
		linear2473 = findViewById(R.id.linear2473);
		linear2474 = findViewById(R.id.linear2474);
		...
		design_isolated_footings = new RequestNetwork(this);
		...
		button1d.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((edittext_am3d.getText().toString().equals("a.m") || edittext_am4d.getText().toString().equals("a.m")) || (edittext_am6d.getText().toString().equals("a.m") || (edittext_am8d.getText().toString().equals("a.m") || edittext_am11d.getText().toString().equals("a.m")))) {
					...
					if (Double.parseDouble(edittext34d.getText().toString()) > (Double.parseDouble(edittext31d.getText().toString()) - Double.parseDouble(edittext_am4d.getText().toString()))) {
						edittext38d.setText(String.valueOf(Math.ceil((Double.parseDouble(edittext34d.getText().toString()) + Double.parseDouble(edittext_am4d.getText().toString())) * 10) / 10));
					}
					else {
						edittext38d.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext31d.getText().toString()) * 10) / 10));
					}
					...
					if (Double.parseDouble(edittext35d.getText().toString()) > (Double.parseDouble(edittext32d.getText().toString()) - Double.parseDouble(edittext_am3d.getText().toString()))) {
						edittext39d.setText(String.valueOf(Math.ceil((Double.parseDouble(edittext35d.getText().toString()) + Double.parseDouble(edittext_am3d.getText().toString())) * 10) / 10));
					}
					else {
						edittext39d.setText(String.valueOf(Math.ceil(Double.parseDouble(edittext32d.getText().toString()) * 10) / 10));
					}
...
الأزاحة e
*/
				edittext10d.setText(String.valueOf(0));
				edittext13d.setText(String.valueOf(0));
			}
...
*/
		...
		_design_isolated_footings_request_listener = new RequestNetwork.RequestListener() {
			@Override
...
*/
		...
		hscroll235.setVisibility(View.GONE);
		linear12d.setVisibility(View.GONE);
		hscroll11d.setVisibility(View.GONE);
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(DipsdDesignOfIsolatedFootingssActivity.this); //change the activity name
