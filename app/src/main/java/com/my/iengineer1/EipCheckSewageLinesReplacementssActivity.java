...
public class EipCheckSewageLinesReplacementssActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eip_check_sewage_lines_replacementss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/zUFRaGnDwag"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesReplacementssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesReplacementssActivity.this.getSystemService(PRINT_SERVICE);
...
*/
		...
		textview13d.setText("منسوب سطح الأحلال عند بداية الفرعة أو الخط");
		final TextView textview32d = dynamic_pipe_line_check_excavation.findViewById(R.id.textview32d);
		textview32d.setText("منسوب سطح الأحلال عند نهاية الفرعة أو الخط");
...
*/
		...
		textview26d.setText("قراءة القامة لسطح الأحلال عند بداية الفرعة أو الخط");
		final TextView textview33d = dynamic_pipe_line_check_excavation.findViewById(R.id.textview33d);
		textview33d.setText("قراءة القامة لسطح الأحلال عند نهاية الفرعة أو الخط");
		/*
...
if (edittext_am31dnn.equals("a.m")) {
					edittext32d.setText(String.valueOf(0.00d));
					edittext_am32d.setText("a.m");
				}
				else {
					edittext32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31dnn)));
					edittext_am32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31dnn)));
				}
						}
...
*/
					...
					textview27dl.setText("قراءة القامة لمنسوب الأحلال التصميمي عند النقطة المرصودة");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام طبقة الأحلال لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط ومنسوب ميه الماسورة بنهاية الفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
