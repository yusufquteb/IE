...
public class ToipccreinforcedconcretecolumnsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipccreinforcedconcretecolumns);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview11.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview11)
				        .autoHide(true, 5000)
		...
		textview7.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview7)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (Double.parseDouble(edittext1.getText().toString()) < 0)) || ((edittext2.getText().toString().equals(".") || ((Double.parseDouble(edittext2.getText().toString()) < 0) || edittext2.getText().toString().equals(""))) || (edittext3.getText().toString().equals("") || (edittext3.getText().toString().equals(".") || (Double.parseDouble(edittext3.getText().toString()) < 0))))) {
		...
		textview988.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview988)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("نسبة حديد التسليح بالأعمدة طبقآ للمقايسة ( كجم / م٣ ) \" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١٨٠ كجم/م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview530.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview530)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview998.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview998)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview965.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview965)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview724.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview724)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview335.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview335)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview340.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview340)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview344.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview344)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview350.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview350)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview1012.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview1012)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("نسبة الهالك بحديد تسليح الأعمدة\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١٠ % \"")
				        .textColor(0xFFFFFFFF)
		...
		textview529.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview529)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview537.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview537)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview348.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview348)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview971.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview971)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview316.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview316)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview844.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview844)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview977.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview977)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview832.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview832)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة والحدادة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للأعمدة التي يتم ادخال أبعادها وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة والحدادة ( جنيه )")
				        .textColor(0xFFFFFFFF)
		...
		textview859.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview859)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview861.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview861)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview962.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview962)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview904.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview904)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("سعر ال م٣ من المياه\n( جنيه / م٣ )\nفي بعض المشروعات لا يتم حساب تكلفة لمياه الخلط وبالتالى يكون سعرها صفر اي بيتم أهمال تكلفة مياه الخلط\n\" مدخل إختياري في حالة عدم الرغبة في إدخاله سيقوم البرنامج بافتراضه بقيمة = ٠٠.٠٠ جنيه/م٣ \"")
				        .textColor(0xFFFFFFFF)
		...
		textview956.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview956)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview929.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccreinforcedconcretecolumnsActivity.this, textview929)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة والحدادة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للأعمدة التي يتم ادخال أبعادها وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة والحدادة ( جنيه )")
				        .textColor(0xFFFFFFFF)
...
*/
		...
		dynamic_element_type.setText("نموذج عمود رقم :");
		dynamic_element_symble.setText("ع");
		...
		/*
شكل ال linears للاعمدة الدينامك
*/
...
*/
		...
		dynamic_element_remove.setText("الغاء العمود\nالحالي");
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccreinforcedconcretecolumnsActivity.this); //change the activity name
