...
public class ToipccExcavationForBuildingsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_excavation_for_buildings);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview63.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview63)
				        .autoHide(true, 5000)
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0))) || ((edittext6.getText().toString().equals("") || edittext6.getText().toString().equals(".")) || (edittext6.getText().toString().equals("-") || (Double.parseDouble(edittext6.getText().toString()) < 0)))) || (((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))))) {
...
*/
		...
		textview1264.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview1264)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
...
*/
		...
		textview408.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview408)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview407.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview407)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview406.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview406)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview432.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview432)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview431.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview431)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview430.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview430)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview416.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview416)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview415.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview415)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview414.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview414)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview420.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview420)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview419.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview419)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview418.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview418)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview412.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview412)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview411.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview411)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview410.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview410)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview424.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview424)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview423.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview423)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* عدد أيام\nالعمل التي\nسيتم استخدام\nتنك أو نقلة\nمياه بها\nلزوم تنفيذ\nالبند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview422.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview422)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview428.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview428)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview427.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview427)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview426.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview426)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview440.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview440)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview439.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview439)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview438.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview438)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview443.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview443)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("اليومية\n( جنيه / يوم ) \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview442.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview442)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview441.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview441)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview607.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview607)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview606.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview606)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview625.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview625)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالبلدوزر\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview624.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview624)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview614.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview614)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nاللودر\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview613.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview613)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview610.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview610)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالجريدر\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview609.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview609)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview619.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview619)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقلة\nللتانك شامل\nتوريد المياه\n( جنيه / نقلة )\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview618.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview618)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview622.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview622)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالهراس\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview621.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview621)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview631.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview631)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview630.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview630)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview633.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview633)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview632.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview632)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button12.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0))) || ((edittext6.getText().toString().equals("") || edittext6.getText().toString().equals(".")) || (edittext6.getText().toString().equals("-") || (Double.parseDouble(edittext6.getText().toString()) < 0)))) || ((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0)))) || (((edittext202.getText().toString().equals("") || edittext202.getText().toString().equals(".")) || (edittext202.getText().toString().equals("-") || (Double.parseDouble(edittext202.getText().toString()) < 0))) || ((edittext203.getText().toString().equals("") || edittext203.getText().toString().equals(".")) || (edittext203.getText().toString().equals("-") || (Double.parseDouble(edittext203.getText().toString()) < 0)))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
		...
		textview634.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccExcavationForBuildingsActivity.this, textview634)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
...
*/
		...
		textview111d.setText("عرض الحفر \n( م )");
...
*/
		...
		textview112d.setText("مسطح حفر مبني واحد \n( م٢ )");
...
*/
		...
		textview113d.setText("إجمالي مسطح الحفر\n( م٢ )");
		/*
إجمالى حجم الحفر
( م٣ )
*/
		...
		textview114d.setText("إجمالى حجم الحفر\n( م٣ )");
		/*
ملاحظة فرق المنسوب
*/
...
edittext5d.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 6)});
		...
		button2d.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext2d.getText().toString().equals("") || edittext2d.getText().toString().equals(".")) || (edittext2d.getText().toString().equals("-") || (Double.parseDouble(edittext2d.getText().toString()) < 0))) || ((edittext6d.getText().toString().equals("") || edittext6d.getText().toString().equals(".")) || (edittext6d.getText().toString().equals("-") || (Double.parseDouble(edittext6d.getText().toString()) < 0)))) || (((edittext4d.getText().toString().equals("") || edittext4d.getText().toString().equals(".")) || (edittext4d.getText().toString().equals("-") || (Double.parseDouble(edittext4d.getText().toString()) < 0))) || ((edittext15d.getText().toString().equals("") || edittext15d.getText().toString().equals(".")) || (edittext15d.getText().toString().equals("-") || (Double.parseDouble(edittext15d.getText().toString()) < 0))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccExcavationForBuildingsActivity.this); //change the activity name
