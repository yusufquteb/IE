...
public class ToipccDrainagePipeLinePriceStudyActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_drainage_pipe_line_price_study);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				drainage_pipe_line.setClass(getApplicationContext(), ToipccDrainagePipeLinePriceStudysActivity.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				drainage_pipe_line.setClass(getApplicationContext(), ToipccDrainagePipeLinePriceStudyssActivity.class);
				startActivity(drainage_pipe_line);
			}
		});
	}
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccDrainagePipeLinePriceStudyActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccDrainagePipeLinePriceStudyActivity.this.getSystemService(PRINT_SERVICE);
