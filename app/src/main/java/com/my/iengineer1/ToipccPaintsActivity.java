...
public class ToipccPaintsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_paints);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/8v13mejw18U"));
				startActivity(price);
			}
		});
...
*/
		...
		d_textview55.setText("المسطح الأجمالي لدهانات جميع الحوائط من هذا النموذج أقل من المسطح الاجمالى لجميع الفتحات");
		/*
...
*/
		d_textview6.setText("مسطح الدهانات للحائط الواحد من هذا النموذج بدون خصم الفتحات ( م٢ )");
		d_textview7.setText("اجمالي مسطحات الدهانات لجميع الحوائط من هذا النموذج بدون خصم الفتحات ( م٢ )");
		d_textview511.setText("م٢");
		d_textview9.setText("المسطح الأجمالي لدهانات جميع الحوائط من هذا النموذج بعد خصم الفتحات ( م٢ )");
...
*/
				...
				textview667bd.setText("من فضلك أعد مراجعة عرض الفتحة حيث ان عرض الفتحة أكبر من عرض وهذا غير منطقي وغير هندسي");
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccPaintsActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccPaintsActivity.this.getSystemService(PRINT_SERVICE);
