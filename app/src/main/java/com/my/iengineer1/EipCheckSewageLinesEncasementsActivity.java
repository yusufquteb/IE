...
public class EipCheckSewageLinesEncasementsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eip_check_sewage_lines_encasements);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/Gm0KIAM_mec"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesEncasementsActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesEncasementsActivity.this.getSystemService(PRINT_SERVICE);
...
*/
		...
		button2dw.setText("أضافة فحص واستلام عرض طبقة تعليف وحماية جديد");
...
*/
		...
		textview26d.setText("قراءة القامة لمنسوب ظهر التغليف عند النقطة التصميمية او عند المطبق التصميمي المراد رفع واستلام الفرعة عنده");
		/*
...
*/
		...
		textview13d.setText("منسوب سطح طبقة الحماية والتغليف للفرعة عند النقطة التصميمية او عند المطبق التصميمي المراد رفع واستلام الفرعة من عنده");
...
*/
					...
					textview17dw.setText("الفرق ( م )\n( عرض سطح طبقة الحماية والتغليف من الأعلي المقاس علي الطبيعة\n-\nالعرض التصميمي عند سطح طبقة الحماية والتغليف )");
					/*
ثانيآ المدخلات والمعادلات
*/
...
if ((edittext_am10dnn.equals("a.m") || edittext_am18dl.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am51d.getText().toString().equals("a.m")))) {
...
if ((edittext_am10d.getText().toString().equals("a.m") || edittext_am18dl.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am51d.getText().toString().equals("a.m")))) {
										edittext20dl.setText(String.valueOf(00.00d));
										edittext_am20dl.setText("a.m");
									}
									else {
...
if ((edittext_am10d.getText().toString().equals("a.m") || edittext_am18dlnn.equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am51d.getText().toString().equals("a.m")))) {
										edittext20dl.setText(String.valueOf(00.00d));
										edittext_am20dl.setText("a.m");
									}
									else {
...
if (((((edittext_am18dl.getText().toString().equals("a.m") || textview118d.getVisibility() == View.VISIBLE) || (textview119dl.getVisibility() == View.VISIBLE || textview120dl.getVisibility() == View.VISIBLE)) || edittext_am10d.getText().toString().equals("a.m")) || (edittext_am8d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am51d.getText().toString().equals("a.m")))) || (edittext_am19dl.getText().toString().equals("a.m") || (edittext_am11d.getText().toString().equals("a.m") || edittext_am12d.getText().toString().equals("a.m")))) {
...
if ((edittext_am10d.getText().toString().equals("a.m") || (edittext_am8d.getText().toString().equals("a.m") || (edittext_am4d.getText().toString().equals("a.m") || edittext_am51d.getText().toString().equals("a.m")))) || edittext_am18dl.getText().toString().equals("a.m")) {
										edittext20dl.setText(String.valueOf(00.00d));
									}
									else {
										if (edittext_am3d.getText().toString().equals("a.m")) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام طبقة التغليف أعلي المواسير لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط والميل التصميمي للفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
