...
public class ToipccPlainconcreteWallsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_plainconcrete_walls);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview378 = findViewById(R.id.textview378);
		...
		textview7.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview7)
				        .autoHide(true, 5000)
		...
		edittext22.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				edittext22.setFilters(new InputFilter[]{new InputFilter.LengthFilter((int) 7)});
				edittext4.setText(String.valueOf(00.00));
				edittext5.setText(String.valueOf(00.00));
				edittext4.setTextColor(0xFFE91E63);
				edittext5.setTextColor(0xFFE91E63);
		...
		textview11.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview11)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (Double.parseDouble(edittext1.getText().toString()) < 0)) || (edittext2.getText().toString().equals("") || (edittext2.getText().toString().equals(".") || (Double.parseDouble(edittext2.getText().toString()) < 0)))) {
					...
					edittext4.setText(String.valueOf((Double.parseDouble(edittext1.getText().toString()) * Double.parseDouble(edittext22.getText().toString())) * Double.parseDouble(edittext2.getText().toString())));
					edittext4.setTextColor(0xFF000000);
					edittext444.setText(String.valueOf(Double.parseDouble(edittext1.getText().toString()) * (Double.parseDouble(edittext2.getText().toString()) * Double.parseDouble(edittext22.getText().toString()))));
...
*/
		...
		textview530.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview530)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button66.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (((edittext52.getText().toString().equals("") || edittext52.getText().toString().equals(".")) || (edittext52.getText().toString().equals("-") || (Double.parseDouble(edittext52.getText().toString()) < 0))) || (Double.parseDouble(edittext52.getText().toString()) > 100)) {
		...
		textview965.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview965)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button65.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (((edittext54.getText().toString().equals("") || edittext54.getText().toString().equals(".")) || (edittext54.getText().toString().equals("-") || (Double.parseDouble(edittext54.getText().toString()) < 0))) || ((edittext55.getText().toString().equals("") || edittext55.getText().toString().equals(".")) || (edittext55.getText().toString().equals("-") || (Double.parseDouble(edittext55.getText().toString()) < 0)))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					if (edittext116.getText().toString().equals("") || (Double.parseDouble(edittext116.getText().toString()) < 0)) {
						edittext116.setText(String.valueOf((long)(00.00d)));
					}
					...
					edittext59.setText(String.valueOf((Double.parseDouble(edittext56.getText().toString()) + Double.parseDouble(edittext58.getText().toString())) + Double.parseDouble(edittext117.getText().toString())));
					edittext60.setText(String.valueOf((Double.parseDouble(edittext57.getText().toString()) + Double.parseDouble(edittext58.getText().toString())) + Double.parseDouble(edittext117.getText().toString())));
					edittext56.setTextColor(0xFF000000);
					edittext57.setTextColor(0xFF000000);
					edittext58.setTextColor(0xFF000000);
					edittext117.setTextColor(0xFF000000);
		...
		textview724.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview724)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview335.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview335)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview340.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview340)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview344.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview344)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview350.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview350)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview529.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview529)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview537.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview537)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview348.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview348)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview971.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview971)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview316.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview316)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button92.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((edittext87.getText().toString().equals("") || edittext87.getText().toString().equals(".")) || (edittext87.getText().toString().equals("-") || (Double.parseDouble(edittext87.getText().toString()) < 0))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
		...
		textview844.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview844)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview977.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview956)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button91.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (((edittext87.getText().toString().equals("") || edittext87.getText().toString().equals(".")) || (edittext87.getText().toString().equals("-") || (Double.parseDouble(edittext87.getText().toString()) < 0))) || (((edittext89.getText().toString().equals("") || edittext89.getText().toString().equals(".")) || (edittext89.getText().toString().equals("-") || (Double.parseDouble(edittext89.getText().toString()) < 0))) || ((edittext90.getText().toString().equals("") || edittext90.getText().toString().equals(".")) || (edittext90.getText().toString().equals("-") || (Double.parseDouble(edittext90.getText().toString()) < 0))))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					...
					edittext93.setText(String.valueOf((Double.parseDouble(edittext91.getText().toString()) + Double.parseDouble(edittext92.getText().toString())) + Double.parseDouble(edittext121.getText().toString())));
					edittext91.setTextColor(0xFF000000);
					edittext92.setTextColor(0xFF000000);
					edittext121.setTextColor(0xFF000000);
					edittext93.setTextColor(0xFFFFFFFF);
		...
		textview832.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview832)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للقواعد التي يتم ادخال أبعاده وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة ( جنيه )")
				        .textColor(0xFFFFFFFF)
		...
		textview859.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview859)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview861.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview861)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview962.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview962)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview904.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview904)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("سعر ال م٣ من المياه\n( جنيه / م٣ )\nفي بعض المشروعات لا يتم حساب تكلفة لمياه الخلط وبالتالى يكون سعرها صفر اي بيتم أهمال تكلفة مياه الخلط\n\" مدخل إختياري في حالة عدم الرغبة في إدخاله سيقوم البرنامج بافتراضه بقيمة = ٠٠.٠٠ جنيه/م٣ \"")
				        .textColor(0xFFFFFFFF)
		...
		button94.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((((edittext94.getText().toString().equals("") || edittext94.getText().toString().equals(".")) || (edittext94.getText().toString().equals("-") || (Double.parseDouble(edittext94.getText().toString()) < 0))) || ((edittext95.getText().toString().equals("") || edittext95.getText().toString().equals(".")) || (edittext95.getText().toString().equals("-") || (Double.parseDouble(edittext95.getText().toString()) < 0)))) || (((edittext96.getText().toString().equals("") || edittext96.getText().toString().equals(".")) || (edittext96.getText().toString().equals("-") || (Double.parseDouble(edittext96.getText().toString()) < 0))) || ((edittext98.getText().toString().equals("") || edittext98.getText().toString().equals(".")) || (edittext98.getText().toString().equals("-") || (Double.parseDouble(edittext98.getText().toString()) < 0))))) || (((edittext99.getText().toString().equals("") || edittext99.getText().toString().equals(".")) || (edittext99.getText().toString().equals("-") || (Double.parseDouble(edittext99.getText().toString()) < 0))) || (((edittext100.getText().toString().equals("") || edittext100.getText().toString().equals(".")) || (edittext100.getText().toString().equals("-") || (Double.parseDouble(edittext100.getText().toString()) < 0))) || ((edittext102.getText().toString().equals("") || edittext102.getText().toString().equals(".")) || (edittext102.getText().toString().equals("-") || (Double.parseDouble(edittext102.getText().toString()) < 0)))))) {
					...
					if (Double.parseDouble(edittext108.getText().toString()) < 100) {
						textview914.setText("نسبة الأسمنت\nبالخلطة الخرسانية\nأقل من ١٠٠ كجم/م٣\nوهذه قيمة صغيرة\nجدآ وغير هندسية");
					}
					else {
						if (Double.parseDouble(edittext108.getText().toString()) > 400) {
							textview914.setText("نسبة الأسمنت\nبالخلطة الخرسانية\nأكبر من ٤٠٠ كجم/م٣\nوهذه قيمة كبيرة\nجدآ وغير هندسية");
						}
						else {
							textview914.setText("");
					...
					edittext111.setText(String.valueOf(((Double.parseDouble(edittext103.getText().toString()) + Double.parseDouble(edittext105.getText().toString())) + Double.parseDouble(edittext107.getText().toString())) + (Double.parseDouble(edittext109.getText().toString()) + (Double.parseDouble(edittext110.getText().toString()) + Double.parseDouble(edittext114.getText().toString())))));
					edittext103.setTextColor(0xFF000000);
					edittext104.setTextColor(0xFF000000);
					edittext105.setTextColor(0xFF000000);
					edittext106.setTextColor(0xFF000000);
		...
		textview929.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccPlainconcreteWallsActivity.this, textview929)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("إجمالي تكلفة النجارة ( جنيه )\nبيتم حسابها علي أساس الكمية التصميمية لا الفعلية لان معظم الخرسانة الموردة بتكون أكبر من التصميمية المحسوبة وبنسب مختلفة غير ثابتة\nوهي = أجمالى كمية الخرسانة للقواعد التي يتم ادخال أبعاده وبياناتها في أول الصفحة ( الكمية التصميمية ) * سعر مصنعية النجارة ( جنيه )")
				        .textColor(0xFFFFFFFF)
	...
	private void initializeLogic() {
		add_dynamic_wall_linear.setVisibility(View.GONE);
		linear256.setVisibility(View.GONE);
		linear337.setVisibility(View.GONE);
		linear178.setVisibility(View.GONE);
		linear140.setVisibility(View.GONE);
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccPlainconcreteWallsActivity.this); //change the activity name
...
*/
		d_textview1.setText("نموذج حائط من الخرسانة العادية رقم :");
		d_textview2.setText("ح.خ.ع");
		d_textview4.setText("* ارتفاع الحائط ( م )");
		d_textview4.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "* ارتفاع الحائط ( م )\nوالمقصود هنا صافي ارتفاع الحائط الخرساني");
				return true;
			}
		});
		d_textview6.setText("كمية الخرسانة العادية بالحائط الواحد ( م٣ )");
		d_textview510.setText("م٣");
		d_textview7.setText("الكمية الأجمالية للخرسانة العادية لجميع الحوائط من نفس النموذج ( م٣ )");
		d_textview511.setText("م٣");
		d_edittext5.setBackgroundColor(0xFFD7CCC8);
		d_textview9.setText("المسطح الأجمالي لخرسانة جميع الحوائط من هذا النموذج بعد خصم الفتحات ( م٢ )");
		...
		d_button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((d_edittext1.getText().toString().equals("") || d_edittext1.getText().toString().equals(".")) || (d_edittext1.getText().toString().equals("-") || (Double.parseDouble(d_edittext1.getText().toString()) < 0))) || ((d_edittext2.getText().toString().equals("") || d_edittext2.getText().toString().equals(".")) || (d_edittext2.getText().toString().equals("-") || (Double.parseDouble(d_edittext2.getText().toString()) < 0)))) {
					...
					d_edittext4.setText(String.valueOf(Double.parseDouble(d_edittext1.getText().toString()) * (Double.parseDouble(d_edittext2.getText().toString()) * Double.parseDouble(d_edittext22.getText().toString()))));
					d_edittext4.setTextColor(0xFF000000);
					d_edittext444.setText(String.valueOf(Double.parseDouble(d_edittext1.getText().toString()) * (Double.parseDouble(d_edittext2.getText().toString()) * Double.parseDouble(d_edittext22.getText().toString()))));
								...
								if (Double.parseDouble(edittext9d.getText().toString()) > Double.parseDouble(d_edittext2.getText().toString())) {
									...
									if (Double.parseDouble(edittext5d.getText().toString()) > Double.parseDouble(d_edittext22.getText().toString())) {
										...
										if (((Double.parseDouble(edittext8d.getText().toString()) * Double.parseDouble(edittext9d.getText().toString())) * (Double.parseDouble(edittext5d.getText().toString()) * Double.parseDouble(edittext11d.getText().toString()))) > (Double.parseDouble(d_edittext1.getText().toString()) * (Double.parseDouble(d_edittext2.getText().toString()) * Double.parseDouble(d_edittext22.getText().toString())))) {
											...
											edittext14d.setText(String.valueOf(Double.parseDouble(edittext8d.getText().toString()) * (Double.parseDouble(edittext9d.getText().toString()) * (Double.parseDouble(edittext11d.getText().toString()) * Double.parseDouble(edittext5d.getText().toString())))));
...
*/
				/*
إجمالي كميات الخرسانة العادية للحوائط دينامك م٣
*/
				temp1 = 0;
				 for(int i=0; i<add_dynamic_wall_linear.getChildCount(); ++i) { 
					 View child=add_dynamic_wall_linear.getChildAt(i); 
				...
				if (Double.parseDouble(edittext1.getText().toString()) < temp1a) {
					...
					if (Double.parseDouble(edittext2.getText().toString()) < temp2b) {
						...
						if (Double.parseDouble(edittext22.getText().toString()) < temp3c) {
							...
							textview667.setVisibility(View.GONE);
							edittext4.setText(String.valueOf(Double.parseDouble(edittext1.getText().toString()) * (Double.parseDouble(edittext2.getText().toString()) * Double.parseDouble(edittext22.getText().toString()))));
							edittext4.setTextColor(0xFF000000);
						}
					}
				}
