...
public class EipexcavationsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eipexcavations);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if ((((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (edittext2.getText().toString().equals("") || edittext2.getText().toString().equals("."))) || (edittext3.getText().toString().equals("") || edittext3.getText().toString().equals(". "))) || (edittext6.getText().toString().equals("") || edittext6.getText().toString().equals("."))) {
					SketchwareUtil.showMessage(getApplicationContext(), "من فضلك أملئ الخانات الفارغة");
				}
				else {
					...
					edittext8.setText(String.valueOf(Double.parseDouble(edittext1.getText().toString()) - Double.parseDouble(edittext7.getText().toString())));
					if (Double.parseDouble(edittext8.getText().toString()) > 0) {
						textview12.setText("النقطة تحتاج للردم\nمنسوب النقطة أوطى من المنسوب التصميمي\nويتم تعويض الفرق ف الأحلال");
						textview12.setTextColor(0xFF4CAF50);
					}
					else {
						if (Double.parseDouble(edittext8.getText().toString()) < 0) {
							textview12.setText("النقطة تحتاج للحفر\nمنسوب النقطة أعلي من المنسوب التصميمي");
							textview12.setTextColor(0xFFE91E63);
						}
						else {
							textview12.setText("النقطة لا تحتاج للحفر أو الردم\nمنسوب النقطة مساوى للمنسوب التصميمي");
		...
		textview704.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
...
*/
		...
		dynamic_point_type.setText("بقاع الحفر");
		...
		dynamic_point_calculation.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((((edittext1.getText().toString().equals("") || edittext1.getText().toString().equals(".")) || (edittext1.getText().toString().equals("-") || (Double.parseDouble(edittext1.getText().toString()) < 0))) || ((edittext2.getText().toString().equals("") || edittext2.getText().toString().equals(".")) || (edittext2.getText().toString().equals("-") || (Double.parseDouble(edittext2.getText().toString()) < 0)))) || ((edittext3.getText().toString().equals("") || edittext3.getText().toString().equals(".")) || (edittext3.getText().toString().equals("-") || (Double.parseDouble(edittext3.getText().toString()) < 0)))) || ((dynamic_point_reading.getText().toString().equals("") || dynamic_point_reading.getText().toString().equals(".")) || (dynamic_point_reading.getText().toString().equals("-") || (Double.parseDouble(dynamic_point_reading.getText().toString()) < 0)))) {
					...
					dynamic_levels_difference.setText(String.valueOf(Double.parseDouble(edittext1.getText().toString()) - Double.parseDouble(dynamic_point_level.getText().toString())));
					if (Double.parseDouble(dynamic_levels_difference.getText().toString()) > 0) {
						dynamic_required_action.setText("النقطة تحتاج للردم\nمنسوب النقطة أوطى من المنسوب التصميمي\nويتم تعويض الفرق ف الأحلال");
						dynamic_required_action.setTextColor(0xFF4CAF50);
					}
					else {
						if (Double.parseDouble(dynamic_levels_difference.getText().toString()) < 0) {
							dynamic_required_action.setText("النقطة تحتاج للحفر\nمنسوب النقطة أعلي من المنسوب التصميمي");
							dynamic_required_action.setTextColor(0xFFE91E63);
						}
						else {
							dynamic_required_action.setText("النقطة لا تحتاج للحفر أو الردم\nمنسوب النقطة مساوى للمنسوب التصميمي");
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipexcavationsActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipexcavationsActivity.this.getSystemService(PRINT_SERVICE);
