...
public class ToipccDrainagePipeLinePriceStudysActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_drainage_pipe_line_price_studys);
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(ToipccDrainagePipeLinePriceStudysActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) ToipccDrainagePipeLinePriceStudysActivity.this.getSystemService(PRINT_SERVICE);
