...
public class EipCheckSewageLinesExcavationActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eip_check_sewage_lines_excavation);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/pcmfoMxa9Fc"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesExcavationActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesExcavationActivity.this.getSystemService(PRINT_SERVICE);
...
if (edittext_am8dnn.equals("a.m") || edittext_am9d.getText().toString().equals("a.m")) {
					edittext13d.setText(String.valueOf(0.00d));
					edittext_am13d.setText("a.m");
				}
				else {
					edittext13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8dnn) - Double.parseDouble(edittext_am9d.getText().toString())));
					edittext_am13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8dnn) - Double.parseDouble(edittext_am9d.getText().toString())));
				}
						}
...
if (edittext_am8d.getText().toString().equals("a.m") || edittext_am9dnn.equals("a.m")) {
					edittext13d.setText(String.valueOf(0.00d));
					edittext_am13d.setText("a.m");
				}
				else {
					edittext13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8d.getText().toString()) - Double.parseDouble(edittext_am9dnn)));
					edittext_am13d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am8d.getText().toString()) - Double.parseDouble(edittext_am9dnn)));
				}
						}
...
if ((Double.parseDouble(edittext14dnn) == 00.00d) || edittext_am16dw.getText().toString().equals("a.m")) {
								edittext17dw.setText(String.valueOf(0.00d));
							}
							else {
								edittext17dw.setText(_English_Decimal_Format(Double.parseDouble(edittext_am16dw.getText().toString()) - Double.parseDouble(edittext14dnn)));
							}
									}
...
if ((Double.parseDouble(edittext14d.getText().toString()) == 00.00d) || edittext_am16dwnn.equals("a.m")) {
								edittext17dw.setText(String.valueOf(0.00d));
							}
							else {
								edittext17dw.setText(_English_Decimal_Format(Double.parseDouble(edittext_am16dwnn) - Double.parseDouble(edittext14d.getText().toString())));
							}
									}
...
if ((Double.parseDouble(edittext14d.getText().toString()) == 00.00d) || edittext_am16dw.getText().toString().equals("a.m")) {
								textview111dw.setVisibility(View.GONE);
								textview112dw.setVisibility(View.GONE);
								textview113dw.setVisibility(View.GONE);
							}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام قاع الحفر لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط والميل التصميمي للفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
