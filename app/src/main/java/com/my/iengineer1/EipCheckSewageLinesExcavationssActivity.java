...
public class EipCheckSewageLinesExcavationssActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.eip_check_sewage_lines_excavationss);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button195.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				price.setData(Uri.parse("https://youtu.be/z2kSFY4CazQ"));
				startActivity(price);
			}
		});
	...
	public void _PrintHelper(final View _view) {
		...
		WebView webView = new WebView(EipCheckSewageLinesExcavationssActivity.this);
		webView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "UTF-8", null);
		webView.setWebViewClient(new WebViewClient() {
			@Override
			public void onPageFinished(WebView view, String url) {
				PrintManager printManager = (PrintManager) EipCheckSewageLinesExcavationssActivity.this.getSystemService(PRINT_SERVICE);
...
*/
		...
		textview13d.setText("منسوب قاع الحفر عند بداية الفرعة أو الخط");
		final TextView textview32d = dynamic_pipe_line_check_excavation.findViewById(R.id.textview32d);
		textview32d.setText("منسوب قاع الحفر عند نهاية الفرعة أو الخط");
...
*/
		...
		textview26d.setText("قراءة القامة لقاع الحفر عند بداية الفرعة أو الخط");
		final TextView textview33d = dynamic_pipe_line_check_excavation.findViewById(R.id.textview33d);
		textview33d.setText("قراءة القامة لقاع الحفر عند نهاية الفرعة أو الخط");
		/*
عرض الأحلال من أعلي
*/
...
if (edittext_am31dnn.equals("a.m") || edittext_am9d.getText().toString().equals("a.m")) {
					edittext32d.setText(String.valueOf(0.00d));
					edittext_am32d.setText("a.m");
				}
				else {
					edittext32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31dnn) - Double.parseDouble(edittext_am9d.getText().toString())));
					edittext_am32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31dnn) - Double.parseDouble(edittext_am9d.getText().toString())));
				}
						}
...
if (edittext_am8d.getText().toString().equals("a.m") || edittext_am9dnn.equals("a.m")) {
				...
				if (edittext_am31d.getText().toString().equals("a.m") || edittext_am9dnn.equals("a.m")) {
					edittext32d.setText(String.valueOf(0.00d));
					edittext_am32d.setText("a.m");
				}
				else {
					edittext32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31d.getText().toString()) - Double.parseDouble(edittext_am9dnn)));
					edittext_am32d.setText(_English_Decimal_Format(Double.parseDouble(edittext_am31d.getText().toString()) - Double.parseDouble(edittext_am9dnn)));
				}
						}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_help) {
			new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                "-----‐---------------------------------\n" +
                "استلام قاع الحفر لفرعة صرف صحي أو خط طرد أو خط مياه أو خط ري أو خط حريق بمعلومية منسوب ميه الماسورة ببداية الفرعة أو الخط ومنسوب ميه الماسورة بنهاية الفرعة أو الخط :\n" +
                "أضافة خط أو فرعة\n" +
                "جديدة")
