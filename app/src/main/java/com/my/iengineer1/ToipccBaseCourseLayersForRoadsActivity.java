...
public class ToipccBaseCourseLayersForRoadsActivity extends AppCompatActivity {
	...
	private HorizontalScrollView hscroll198;
	...
	private HorizontalScrollView hscroll221;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.toipcc_base_course_layers_for_roads);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		hscroll198 = findViewById(R.id.hscroll198);
		...
		textview2380 = findViewById(R.id.textview2380);
		...
		hscroll221 = findViewById(R.id.hscroll221);
		...
		textview57.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview57)
				        .autoHide(true, 5000)
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0)))) || ((((edittext7.getText().toString().equals("") || edittext7.getText().toString().equals(".")) || edittext7.getText().toString().equals("-")) || ((edittext8.getText().toString().equals("") || edittext8.getText().toString().equals(".")) || edittext8.getText().toString().equals("-"))) || ((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))))) {
					...
					edittext11.setText(String.valueOf(Double.parseDouble(edittext199.getText().toString()) * Double.parseDouble(edittext15.getText().toString())));
					edittext12.setText(String.valueOf(Double.parseDouble(edittext15.getText().toString()) * Double.parseDouble(edittext10.getText().toString())));
...
*/
		...
		textview1264.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview1264)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
...
*/
		...
		textview416.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview416)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview415.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview415)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview414.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview414)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview420.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview420)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقل\n( جنيه / م٣ )\nوهو يعبر عن المبلغ الذي يتكلفة النقل للمواد الأحلال والردم من الحاجر الي موقع العمل أو داخل الموقع بالجنيه لكل ١م٣\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview419.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview419)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview418.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview418)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* حمولة\nالسيارة\n( م٣ )\n\nوهو يعبر عن الكمية التي يمكن تقوم السيارة النقل بنقلها من مواد طبقة الأساس من المحاجر الي موقع العمل أو داخل الموقع \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٢٠ م٣ \"")
				        .textColor(0xFFFFFFFF)
				        .color(0xFF607D8B)
				        .corner((int) 25)
				        .arrowWidth((int) 25)
		...
		textview408.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview408)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview407.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview407)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview406.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview406)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview412.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview412)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview411.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview411)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview410.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview410)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview424.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview424)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview423.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview423)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* عدد أيام\nالعمل التي\nسيتم استخدام\nتنك أو نقلة\nمياه بها\nلزوم تنفيذ\nالبند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview422.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview422)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview428.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview428)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview427.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview427)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview426.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview426)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview440.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview440)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview439.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview439)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview438.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview438)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview443.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview443)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("اليومية\n( جنيه / يوم ) \n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ٠.٠٠ جنيه / يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview442.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview442)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("عدد أيام\nالعمل\nالمفترضة\nلتنفيذ البند\n\" مدخل إختياري في حالة عدم إدخاله سيقوم البرنامج بإفتراضه بقيمة = ١ يوم \"")
				        .textColor(0xFFFFFFFF)
		...
		textview441.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview441)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview614.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview614)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview613.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview613)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview625.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview625)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nفنشر أساس \n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview624.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview624)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview610.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview610)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالجريدر\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview609.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview609)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview619.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview619)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("* سعر النقلة\nللتانك شامل\nتوريد المياه\n( جنيه / نقلة )\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview618.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview618)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview622.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview622)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
				        .text("يومية\nالهراس\n\" مدخل إختياري في حالة عدم إدخاله\nسيقوم البرنامج بأفتراضه بقيمة = ٠.٠٠ \"\nبمعني أنه لم يتم استخدام هذه المعدة بالعمل")
				        .textColor(0xFFFFFFFF)
		...
		textview621.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview621)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview631.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview631)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview630.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview630)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview633.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview633)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		textview632.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview632)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
		...
		button12.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (((((edittext4.getText().toString().equals("") || edittext4.getText().toString().equals(".")) || (edittext4.getText().toString().equals("-") || (Double.parseDouble(edittext4.getText().toString()) < 0))) || ((edittext5.getText().toString().equals("") || edittext5.getText().toString().equals(".")) || (edittext5.getText().toString().equals("-") || (Double.parseDouble(edittext5.getText().toString()) < 0)))) || ((edittext6.getText().toString().equals("") || edittext6.getText().toString().equals(".")) || (edittext6.getText().toString().equals("-") || (Double.parseDouble(edittext6.getText().toString()) < 0)))) || ((((edittext7.getText().toString().equals("") || edittext7.getText().toString().equals(".")) || (edittext7.getText().toString().equals("-") || (Double.parseDouble(edittext7.getText().toString()) < 0))) || ((edittext8.getText().toString().equals("") || edittext8.getText().toString().equals(".")) || (edittext8.getText().toString().equals("-") || (Double.parseDouble(edittext8.getText().toString()) < 0)))) || ((((edittext15.getText().toString().equals("") || edittext15.getText().toString().equals(".")) || (edittext15.getText().toString().equals("-") || (Double.parseDouble(edittext15.getText().toString()) < 0))) || ((edittext201.getText().toString().equals("") || edittext201.getText().toString().equals(".")) || (edittext201.getText().toString().equals("-") || (Double.parseDouble(edittext201.getText().toString()) < 0)))) || (((edittext203.getText().toString().equals("") || edittext203.getText().toString().equals(".")) || (edittext203.getText().toString().equals("-") || (Double.parseDouble(edittext203.getText().toString()) < 0))) || ((edittext202.getText().toString().equals("") || edittext202.getText().toString().equals(".")) || (edittext202.getText().toString().equals("-") || (Double.parseDouble(edittext202.getText().toString()) < 0))))))) {
					...
					edittext235.setTextColor(0xFF000000);
					edittext237.setText(String.valueOf(((Double.parseDouble(edittext232.getText().toString()) + Double.parseDouble(edittext228.getText().toString())) + (Double.parseDouble(edittext217.getText().toString()) + Double.parseDouble(edittext225.getText().toString()))) + (((Double.parseDouble(edittext227.getText().toString()) + Double.parseDouble(edittext230.getText().toString())) + Double.parseDouble(edittext231.getText().toString())) + (Double.parseDouble(edittext234.getText().toString()) + Double.parseDouble(edittext235.getText().toString())))));
		...
		textview634.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				ViewTooltip
				        .on(ToipccBaseCourseLayersForRoadsActivity.this, textview634)
				        .autoHide(true, 5000)
				        .position(ViewTooltip.Position.TOP)
...
*/
	...
	public void _PrintHelper(final View _view) {
		...
		_view.draw(canvas);
		PrintHelper printHelper = new PrintHelper(ToipccBaseCourseLayersForRoadsActivity.this); //change the activity name
...
*/
		...
		/*
ميل جوانب طبقة الأساس
*/
		final TextView textview341d = dynamic_pipe_line_linear.findViewById(R.id.textview341d);
		textview341d.setText("ميل جوانب طبقة الأساس\n( الميل الجانبي لطبقات الأساس للطريق )");
		/*
...
*/
		...
		linear201d.setVisibility(View.GONE);
		linear613d.setVisibility(View.GONE);
		...
		button2d.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ((((edittext4d.getText().toString().equals("") || edittext4d.getText().toString().equals(".")) || (edittext4d.getText().toString().equals("-") || (Double.parseDouble(edittext4d.getText().toString()) < 0))) || ((edittext5d.getText().toString().equals("") || edittext5d.getText().toString().equals(".")) || (edittext5d.getText().toString().equals("-") || (Double.parseDouble(edittext5d.getText().toString()) < 0)))) || ((((edittext7d.getText().toString().equals("") || edittext7d.getText().toString().equals(".")) || edittext7d.getText().toString().equals("-")) || ((edittext8d.getText().toString().equals("") || edittext8d.getText().toString().equals(".")) || edittext8d.getText().toString().equals("-"))) || ((edittext15d.getText().toString().equals("") || edittext15d.getText().toString().equals(".")) || (edittext15d.getText().toString().equals("-") || (Double.parseDouble(edittext15d.getText().toString()) < 0))))) {
					...
					edittext11d.setText(String.valueOf(Double.parseDouble(edittext199d.getText().toString()) * Double.parseDouble(edittext15d.getText().toString())));
					edittext12d.setText(String.valueOf(Double.parseDouble(edittext15d.getText().toString()) * Double.parseDouble(edittext10d.getText().toString())));
