...
if (isset($_POST['login'])) {
  ...
  if ($check_user == 1) {
    ...
    echo "
<div class='alert alert-success' style='color:white;'  role='alert'><strong>Done ! </strong>User Was Found</div>
  ";
  echo "<script>window.open('home.php','_self')</script>";
}else {
echo "
  <div class='alert alert-danger' style='color:white; role='alert'><strong>Failed ! </strong>User Was Not Found</div>
";
exit();
}
}
if (isset($_POST['reg'])) {
  ...
  if ($check_u == 1) {
    echo "
<div class='alert alert-warning' style='color:white; role='alert'><strong>Wait ! </strong>User Name Already Used</div>
  ";
}else {
